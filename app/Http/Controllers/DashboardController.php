...
class DashboardController extends Controller
{
    public function index()
    {
        try {
            ...
            $totalMale = Applicant::leftJoin('passports', 'passports.id', 'applicants.passport_id')->where('passports.gender', 'Male')->count();
            $totalFemale =   Applicant::leftJoin('passports', 'passports.id', 'applicants.passport_id')->where('passports.gender', 'Female')->count();
            $data = [
                'total_applicant' => \DB::table('applicants')->count(),
                'applicants' => $applicants = Applicant::leftJoin('passports', 'passports.id', 'applicants.passport_id')
