...
class CountryController extends Controller
{
    ...
    public function index()
    {
      try{
            ...
            return view('addCountry.index')->with(['countries'=>$countries]);
      }catch(\Exception $e)
      {
    ...
    public function create()
    {
        try{
            ...
            return view('addCountry.form')->with(['continentsList'=>$continentsList]);
    ...
    public function edit($id)
    {
        try{
            ...
            $continentsList = $this->continentRepository->getContinentForSelect();
            return view('addcountry.form')->with(['editData'=>$editData, 'continentsList'=>$continentsList]);
