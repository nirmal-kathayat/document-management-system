...
class DemandController extends Controller
{
  ...
  public function index()
  {
    try {
      ...
      return view('backup.addDemand.index')->with(['demands'=>$demands]);
    } catch (\Exception $e) {
  ...
  public function create()
  {
    try {
      ...
      return view('backup.addDemand.form')->with(['experiences'=>$experiences]);
    } catch (\Exception $e) {
      return redirect()->back()->with(['error' => 'An error occurred while fetching  data.']);
    }
  }
  ...
  public function edit($id)
  {
    try{
      ...
      return view('backup.addDemand.form')->with(['editData'=>$editData,'experiences'=>$experiences]);
